# ![LOGO](logo.png) Amazon Comprehend MSP Connector

## Description

A generated MSP connector for the Amazon Comprehend API (version 2017-11-27).
...
flowground :- Telekom iPaaS / amazonaws-com-comprehend-connector<br/>
